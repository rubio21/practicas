...
for ii in range(9):
    path_imgL='puzzle/' +str(ii) + '.jpg'
    path_imgR='puzzle/' +str(ii+1) + '.jpg'
    ...
    img1 = cv.resize(cv.imread(path_imgL, cv.IMREAD_GRAYSCALE), (1024,768))
    img2 = cv.resize(cv.imread(path_imgR, cv.IMREAD_GRAYSCALE), (1024,768))
    ...
    img1 = cv.resize(cv.imread(cv.samples.findFile(path_imgL)),(1024,768))
    img2 = cv.resize(cv.imread(cv.samples.findFile(path_imgR)),(1024,768))
    # Rectify (undistort) the images and save them
    img1_rectified = cv.warpPerspective(img1, H1, (w1, h1))
    img2_rectified = cv.warpPerspective(img2, H2, (w2, h2))
    cv.imwrite("rectified/" +str(ii) + ".png", img1_rectified)
    cv.imwrite("rectified/" +str(ii+1) + ".png", img2_rectified)
    ...
    print(path_imgL, img1_rectified.shape)
    print(path_imgR, img2_rectified.shape)
    print('-----')
    cv.waitKey()
